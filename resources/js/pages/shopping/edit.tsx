...
import { AlertTriangle, ArrowLeft, Calendar, FolderSync, Plus, RefreshCw, ShoppingCart, Store, Trash2 } from 'lucide-react';
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-6 p-6 bg-orange-500 rounded-2xl text-white shadow-lg shadow-orange-200 dark:shadow-none">
                    ...
                    <div className="md:hidden flex items-center gap-3">
                      <Button
                        ...
                        size="icon"
                        onClick={() =>
                          router.visit(shopping.active().url, {
                            preserveScroll: true
                          })
                        }
                        className="text-slate-300 hover:text-slate-50 hover:bg-slate-700 rounded-full transition-colors cursor-pointer"
                      >
